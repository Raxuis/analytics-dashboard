    ...
    <main className="flex min-h-screen items-center justify-center">
      <Card className='flex flex-col items-center gap-3 w-75 duration-700 hover:scale-105'>
        ...
        <ul className='flex gap-5 text-dark-tremor-content-subtle'>
          <a target='_blank' href='https://github.com/Raxuis'><Github className='duration-500 hover:text-tremor-brand-faint' /></a>
          <a target='_blank' href='https://linkedin.com/in/raphael-raclot'><Linkedin className='duration-500 hover:text-tremor-brand-faint' /></a>
          <a target='_blank' href='https://X.com/I_Haruki_I'><Twitter className='duration-500 hover:text-tremor-brand-faint' /></a>
          <a target='_blank' href='/analytics'><Activity className='duration-500 hover:text-tremor-brand-faint' /></a>
          <a target='_blank' href='https://raphaelraclot.vercel.app'><Code className='duration-500 hover:text-tremor-brand-faint' /></a>
        </ul>
      </Card>
    </main>
  );
